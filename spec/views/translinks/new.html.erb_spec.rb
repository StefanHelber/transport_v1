...
describe "translinks/new" do
  before(:each) do
    assign(:translink, stub_model(Translink,
      :supplysite_id => 1,
      :demandsite_id => 1,
      :unit_cost => 1.5,
  ...
  it "renders new translink form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => translinks_path, :method => "post" do
